...
import com.irm.dao.CommentRepository;
import com.irm.po.Comment;
import com.irm.service.CommentService;
...
public class CommentServiceImpl implements CommentService {
    ...
    public Comment saveComment(Comment comment) {
        ...
        if (parentComment != -1) {
            comment.setParentComment(commentRepository.findById(parentComment).get());
        } else {
